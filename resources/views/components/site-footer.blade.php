...
<footer @class([
  'site-footer',
  'site-footer--compact' => ! request()->routeIs('home', 'about', 'contact', 'gallery', 'faq', 'blog.*', 'wholesale', 'privacy', 'terms', 'shop.*', 'cart.show', 'checkout.show', 'checkout.confirmation', 'payment.pay'),
])>
  <div class="container">
